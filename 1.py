...
The first value in the tuple must be the number of even integers in readings.
The second value must be the sum of the even integers in readings.
You may not modify the list passed as an argument in any way, even temporarily.
