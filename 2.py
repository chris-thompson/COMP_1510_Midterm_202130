...
Define a function called pointless_flex.
This function accepts a single parameter, a positive non-zero integer called upper_bound.

The function calculates and returns the sum of all the multiples of 3 or 5
